...
public class MainVerticle extends AbstractVerticle {
	...
	public void start(Promise<Void> startPromise) throws Exception {
		...
		final String appHome = System.getenv("APP_HOME") != null 
				? System.getenv("APP_HOME") : System.getProperty("user.dir");
	...
	private void startup(final AsyncResult<JsonObject> ar) {
		if (ar.succeeded()) {
			...
			final String payload = ar.result().getString("static-payload");
